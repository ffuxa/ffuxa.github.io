...
class CastingCallNumeroDos extends Component {
  ...
  componentDidMount() {
    ...
    console.log(
      "(also pls don't look through the src code, this was hacked together so it's garbage lol"
    );
  ...
  onSearchSubmit(e) {
    e.preventDefault();
    alert(
      "did you actually think I'd go through the trouble of coding search functionality for a casting call? Was an entire webpage not enough? smh"
    );
  }
  ...
  playOrPauseSound(name) {
    ...
    if (audio.duration > 0 && !audio.paused) {
      ...
      for (const instID of this.state.sounds) {
        if (name !== instID) {
      ...
      <div>
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
          <a
            ...
            href="http://www.organicspices.com/"
            target="_blank"
            rel="noreferrer"
          >
            Spicy Inc.
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item active">
                <a className="nav-link" href="#welcome-container">
                  Welcome <span className="sr-only">(current)</span>
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#song-info-container">
                  Song Info
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#instruments-container">
                  Instruments
                </a>
              </li>
              <li className="nav-item">
        ...
        <div id="welcome-container" className="section">
          ...
          <small className="center" style={{ fontSize: "3px" }}>
            This was supposed to spin in the middle...
          </small>
        </div>
        ...
        <div id="song-info-container" className="section">
          <a
            style={{ fontSize: "9px", float: "left" }}
            href="https://www.youtube.com/watch?v=sCNrK-n68CM"
            target="_blank"
            rel="noreferrer"
          >
            Click me!
          ...
          <p>
            ...
            . It's latin. Like this guy.
          </p>

          <img
            height="200"
            width="200"
            src={require("./images/latinactor2.jpg")}
            alt=""
          />
          ...
          <img
            height="200"
            width="200"
            src={require("./images/badbunny.jpg")}
            alt=""
          />
          <br />
          <small style={{ fontSize: "8px" }}>
            Btw{" "}
            <a
              href="https://open.spotify.com/album/7CjJb2mikwAWA1V6kewFBF"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <p>
            It's based on{" "}
            <a
              href="https://www.youtube.com/watch?v=Ns9YYSqLxyI&index=1&list=RDQMc74ayv-iMFM"
              target="_blank"
              rel="noreferrer"
            >
              this
            </a>{" "}
            song by one of Puerto Rico's greatest exports, Marc Anthony.
          </p>
          ...
          <br />
          <p>
            Each part in itself isn't very complicated (except maybe piano?) but
            together it makes a SEXY. ASS. BEAT. YO.
          </p>
          ...
          <br />
          <p>
            The song on noteflight contains the basic boilerplate of the song,
            but I expect us to modify it and play around with it as we go along
          </p>
          <p>
            Also, expect to improvise! Again, the written part is just
            boilerplate and a bit repetitive at times, so I expect us all to
            improvise and feel the rhythm as we play it. Should make it really
            fun and groovy that way!
          </p>
          <br />
          <br />

          <p>
            Btw I plan on playing one of the instruments below but I'm not sure
            which one... probably congas unless there's a large demand for that
            or something. Idk
          </p>
          <br />
          <br />
          ...
          <p>
            <strong>
              <a
                ...
                rel="noreferrer"
              >
                Here's the link to the noteflight in case you're interested in
                hearing it!
              </a>
            </strong>
          </p>
        ...
        <div id="instruments-container" className="section">
          ...
          <div className="container" style={{ paddingTop: "20px" }}>
            <div className="row">
              <div
                className="col-sm center2"
                onClick={() => this.playOrPauseSound("sax")}
              >
                <img
                  height="100"
                  width="100"
                  src={require("./images/sax.jpg")}
                  alt=""
                />
                <p>
                  (
                  <a
                    href="https://google.com/search?q=boobies+and+sexy+time+pls"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Sex
              ...
              <div
                className="col-sm center2"
                onClick={() => this.playOrPauseSound("congas")}
              >
                <img
                  height="100"
                  width="100"
                  src={require("./images/congas.jpg")}
                  alt=""
                />
                <p>Congas</p>
              </div>
              <div
                className="col-sm center2"
                onClick={() => this.playOrPauseSound("bongos")}
              >
                <img
                  height="100"
                  width="100"
                  src={require("./images/bongos.jpg")}
                  alt=""
                ...
                <img
                  height="100"
                  width="100"
                  src={require("./images/cowbell.jpg")}
                  alt=""
                />
                <p>Bongos/Cowbell</p>
              </div>
            ...
            <div className="row">
              <div
                className="col-sm center2"
                onClick={() => this.playOrPauseSound("guiro")}
              >
                <img
                  height="100"
                  width="100"
                  src={require("./images/guiro.jpg")}
                  alt=""
                />
                <p>Guiro</p>
              </div>
              <div
                className="col-sm center2"
                onClick={() => this.playOrPauseSound("bass")}
              >
                <img
                  height="100"
                  width="100"
                  src={require("./images/bass.jpg")}
                  alt=""
                />
                <p>Bass</p>
              </div>
              <div
                className="col-sm center2"
                onClick={() => this.playOrPauseSound("keyboard")}
              >
                <img
                  height="100"
                  width="100"
            ...
            <div className="row">
              <div
                className="col-sm center2"
                onClick={() => this.playOrPauseSound("timbales")}
              >
                <img
                  height="100"
                  width="100"
                  src={require("./images/timbales.jpg")}
                  alt=""
                />
                <p>Timbales</p>
              </div>
              <div
                className="col-sm center2"
                onClick={() => this.playOrPauseSound("trombone")}
              >
                <img
                  height="100"
                  width="100"
                  src={require("./images/trombone.jpg")}
                  alt=""
                />
                <p>Trombone</p>
              </div>
              <div
                className="col-sm center2"
                onClick={() => this.playOrPauseSound("trumpet")}
              >
                <img
                  height="100"
                  width="100"
                  src={require("./images/trumpet.jpg")}
                  alt=""
                />
                <p>Trumpet</p>
              </div>
        ...
        {this.state.sounds.map(
          (inst, index) => (
            <audio id={inst} key={index}>
              <source src={require(`./audio/${inst}.mp3`)} type="audio/mp3" />
            </audio>
          )
